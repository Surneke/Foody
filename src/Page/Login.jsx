        ...
        >
              <KonohaUp/>
                <Box 
                    ...
                    alignItems="center"
                    >
                    <Typography color="#474B5A" variant="h4">Нэвтрэх</Typography>
                    <Box 
                            display="flex" 
                            flexDirection="column"
                            gap='15px'
                            ...
                            mt="30px"
                        >
                        <TextField value={email} onChange={e=>setEmail(e.target.value)}  label="ИМэйл" fullWidth/>
                        <TextField label="Нууц үг" fullWidth/>
                        <Button 
                        onClick={()=>sentMessage()}  variant="contained" sx={{color: "#fff"  }} >Баталгаажуулах</Button>
                    </Box>
                </Box>
                <Konoha/>
          </Box>
